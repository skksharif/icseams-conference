...
const SponsorsPage: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Sponsors" 
        description="ICMISI-2025 is proudly sponsored by leading organizations in the fields of sustainable energy and advanced manufacturing systems." 
        canonical="/sponsors"
      />
      <div className="bg-gradient-to-r from-conference-green/90 to-conference-orange/90 text-white py-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg opacity-90" data-aos="fade-up" data-aos-delay="200">
            ICMISI-2025 is supported by leading organizations in industry and academia
          </p>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12" data-aos="fade-up">
            <p className="text-gray-700 mb-8">
              We extend our sincere gratitude to all our sponsors for their generous support in making ICMISI-2025 a success. Their contributions enable us to organize a high-quality conference and provide a platform for researchers and professionals to share knowledge and innovations.
            </p>
