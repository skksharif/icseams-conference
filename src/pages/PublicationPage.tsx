    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <div className="flex items-start space-x-2 text-green-600">
                ...
                <p className="text-lg font-medium">Publication Confirmed</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6 mb-16">
          ...
          <div
            className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            ...
            <p className="text-gray-600 mb-4">
              View the official conference listing and publication details on
              MATEC Web of Conferences
            </p>
            <a
          ...
          {/* Indexing */}
          <div
            className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            <div className="flex items-center mb-4">
            ...
            <p className="text-gray-600 mb-4">Click here to know about indexing</p>
            <a
              href="https://www.matec-conferences.org/about-the-journal/indexed-in"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-green-600 hover:text-green-800 font-medium transition-colors"
            >
              <ExternalLink className="w-4 h-4 mr-2" />
              Click here to know about indexing
            </a>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4 text-gray-700">
              <p className="leading-relaxed">
                MATEC Web of Conferences is an open access conference
                proceedings series covering materials science, engineering, and
                chemistry. All papers published in MATEC Web of Conferences are
                indexed in Web of Science and other major academic databases.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Included in Web of Science and other major academic
                      databases
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Rigorous review process maintained
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Quick turnaround time for authors
                    </p>
                  </div>
                </div>
              </div>
