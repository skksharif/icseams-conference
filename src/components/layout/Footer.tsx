    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              2<sup>nd</sup> International Conference on Materials Innovation and Sustainable
              Infrastructure
            </p>
            <div className="flex items-center gap-2 text-gray-300 mb-2">
              <Calendar size={16} />
              <span>1<sup>st</sup> & 2<sup>nd</sup> April 2026</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="flex gap-6">
                <div className="">
                  <Phone size={16} className="0" />
                  <span>
                    <strong>Dr. V S J Yeswanth Paluri</strong>
                    <br />
                    Assoc. Professor, CIVIL
                    <br />
                    <a
                      href="tel:+919553314600"
                      className="hover:text-conference-orange transition-colors"
                    >
                      +91 9553314600
                    </a>
                ...
                <div className="">
                  ...
                  <span>
                    <strong>Mr. SK.S. Alisha</strong>
                    <br />
                    Asst. Professor, CIVIL
                    <br />
                    <a
                      href="tel:+917660082181"
                      className="hover:text-conference-orange transition-colors"
                    >
                      +91 7660082181
                    </a>
        ...
        <div className="mt-10 pt-6 border-t border-gray-700 text-center text-gray-400 text-sm">
          <p>
            &copy; {currentYear} Vishnu Institute of Technology. All Rights
            Reserved.
          </p>
        </div>
      </div>
